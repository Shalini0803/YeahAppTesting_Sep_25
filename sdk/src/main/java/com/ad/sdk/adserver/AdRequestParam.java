...
public class AdRequestParam extends Config {
    ...
    public AdRequestParam GenerateRequestURL(Device_settings dInfo, YeahAdsInitialize imgad) {
       ...
       /* //mediation ID
        url_params.put("mediationid", "0");
        url_params.put("NOTINid", String.valueOf(imgad.getZoneid()));
...
//        for (Map.Entry<String, String> entry : imgad.getUserInfo().entrySet()) {
//            System.out.println("** Key = " + entry.getKey() +
//                    ", Value = " + entry.getValue());
//            h_params.put(entry.getKey(), entry.getValue());
//        }
