...
public class YeahAdsInitialize extends FrameLayout {
    ...
    private YeahAdsInitialize adv1;
    ...
    public YeahAdsInitialize(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        setup(context, attrs);
        // TODO Auto-generated constructor stub
    }

    public YeahAdsInitialize(Context context, AttributeSet attrs) {
        super(context, attrs);
        setup(context, attrs);
    }

    //basic ads
    public YeahAdsInitialize(Context context, BannerListener bannerListener) {
        super(context);
        setAdListener(bannerListener);
        setup(context, null);
    }

    public YeahAdsInitialize(Context context, String pulisherId, AdViewListener listener) {
        super(context);
        setup(context, null);
        setAdListener(listener);
        this.zoneid = pulisherId;
        LoadAd();
    }

    //Interstitial Image ads
    public YeahAdsInitialize(Context context, InterstitialImageAdListener listener) {
        super(context);
        setAdListener(listener);
        setup(context, null);
    }
    ...
    public YeahAdsInitialize(Context context, LinearLayout adview, AdViewListener listener) {
        super(context);
    ...
    //Native Ads Start
    public YeahAdsInitialize(Context context, RelativeLayout adview) {
        super(context);
        this.adViewContext = context;
        rlayout = adview;
    }
    ...
    public void LoadAd(YeahAdsInitialize adv1) {
